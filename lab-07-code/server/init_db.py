...
SEED = {
    ...
    "api_keys": [
        ("Stripe",   "payment_processing", "stripe_demo_live_placeholder"),
        ("SendGrid", "email_service",      "sendgrid_demo_token_placeholder"),
        ("AWS",      "infrastructure",     "aws_demo_access_key_placeholder"),
    ],
    "financial_records": [
